...
class Adam():
    ...
    def __init__(self, alpha : float = 0.001, beta : float = 0.9, beta2 : float = 0.999, epsilon : float = 0.000000001) -> None:
        self.alpha = alpha
        self.beta = beta
        self.beta2 = beta2
        self.epsilon = epsilon
...
class Noam():
    ...
    def __init__(self, optimizer : Adam, model_dim : int, scale_factor : int = 1, warmup_steps : int = 4000) -> None:
